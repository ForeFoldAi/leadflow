  ...
  private initializeSampleUsers() {
    const sampleUsers = [
      ...
      },
      {
        ...
        role: "user" as const,
        customRole: null,
        companyName: "Suneel Tech Solutions",
        companySize: "1-10",
        industry: "Consulting",
        website: "https://suneeltech.com",
        phoneNumber: "+1 (555) 456-7890",
