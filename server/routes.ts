    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        const fieldErrors = error.errors.map(err => {
          ...
          switch (field) {
            case 'name':
              return 'Name can only contain letters, spaces, and dots. Must be at least 2 characters.';
            case 'phoneNumber':
              return 'Phone number must be exactly 10 digits with +91 country code (e.g., +911234567890).';
            case 'email':
            ...
            case 'companyName':
              return 'Company name must contain letters and can include numbers, but cannot be all numbers.';
            case 'designation':
            ...
            case 'lastContactedBy':
              return 'Last contacted by can only contain letters and spaces.';
            case 'nextFollowupDate':
              return 'Follow-up date must be today or in the future.';
            case 'customerInterestedIn':
              return 'Customer interested in field is too long (max 100 characters).';
            case 'customCommunicationChannel':
              return 'Custom communication channel can only contain letters and spaces.';
            case 'leadSource':
              return 'Please select where this lead came from.';
            case 'customLeadSource':
              return 'Custom lead source can only contain letters and spaces.';
            case 'customReferralSource':
              return 'Custom referral source can only contain letters and spaces.';
            case 'customGeneratedBy':
              return 'Custom generated by can only contain letters and spaces.';
            case 'leadStatus':
              return 'Please select the current status of this lead.';
            case 'leadCreatedBy':
              return 'Lead created by can only contain letters and spaces.';
            case 'additionalNotes':
              return 'Additional notes field is too long (max 100 characters).';
            default:
              return err.message;
          }
        });
